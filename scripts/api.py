...
def api(_: gr.Blocks, app: FastAPI):
    @app.post("/instaswap/image")
    async def instaswap_image(
        ...
        face_model: str = Body("None",title="Filename of the face model (from 'models/instaswap/faces'), e.g. elena.safetensors"),
